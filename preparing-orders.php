...
if (isset($_GET['status'])) {
  $status = $_GET['status'];
  $id = $_GET['id'];
  $update = "UPDATE tbl_status SET trans_status='$status' WHERE trans_no = $id";
...
<body>
  ...
  <div class="content">
    ...
    <div class="cart">
      <h1 class="title">Preparing Orders</h1>

      <?php
      $select = "SELECT * FROM tbl_status LEFT JOIN tbl_user ON tbl_status.email = tbl_user.email WHERE trans_status = 'Preparing'";
          ...
          print "
            ...
            <div class='status'>
              <div class='custom-select'>
                <select name='status' id='status' onchange='getComboPrepare(this, $trans_no1)'>
