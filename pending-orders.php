...
<body>
  ...
  <div class="content">
    ...
    <div class="cart">
      ...
      <?php
      $select = "SELECT * FROM tbl_status LEFT JOIN tbl_user ON tbl_status.email = tbl_user.email WHERE trans_status = 'Pending'";
          ...
          print "
            ...
            <div class='status'>
              <div class='custom-select'>
                <select name='status' id='status' onchange='getCombo(this, $trans_no1)'>
